 ...
 * qualquer quantidade de interfaces mas herda somente de uma classe concreta
 * por meio de herança simples em java. Podem ter construtores mas não
 * podem ser instanciados diretamente, tendo essa funçao 
 ...
 */
public abstract class ClasseAbstrata extends Super_ClasseAbstrata implements IInterface01{
	public ClasseAbstrata(String nome) {
		super(nome);
	}
}
