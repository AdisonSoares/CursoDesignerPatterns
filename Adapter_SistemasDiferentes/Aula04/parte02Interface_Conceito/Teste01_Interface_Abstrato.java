 ...
 * construtores.
 * 
 * @É_possível_invocar o construtor de uma classe concreta, que é uma classe simples
 * que implementa classes abstratas e interfaces.
 *
 * @Uso_de_implementação concreta é aconselhável, pois é a melhor escolha para se
 * aproveitar o polimorfismo, pelo principio de se programar para interface.
 * 
 * @TratarObjeto a partir de uma referencia de super classe caracteriza o polimorfismo,
 * "Super_ClasseAbstrata superClasseAbstrata(super classe) =
 * new ClasseConcreta01("Nome02");(objeto)". O mesmo efeito pode ser alcançado por meio
 * de uma interface.
 * 
...
public class Teste01_Interface_Abstrato {
	...
	public static void main(String[] args) {
		...
		SuperInterface01 superInterface01 = new ClasseConcreta("Nome04"); 
		
		//Acessando as constantes de intefaces
		System.out.println("Valor constante Interface01: "+Interface01.CONSTANTE01);
		System.out.println("Valor 01 constante Interface02: "+Interface02.CONSTANTE02);
		System.out.println("Valor 02 constante Interface02: "+Interface02.CONSTANTE03);
		System.out.println();
