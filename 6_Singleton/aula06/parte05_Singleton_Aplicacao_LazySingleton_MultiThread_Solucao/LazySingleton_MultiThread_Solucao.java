 ...
 */
public class LazySingleton_MultiThread_Solucao {
	private static LazySingleton_MultiThread_Solucao instancia;
		
	private LazySingleton_MultiThread_Solucao() {
	}
	
	public static synchronized LazySingleton_MultiThread_Solucao getInstancia() {
		if(instancia == null) {
			instancia = new LazySingleton_MultiThread_Solucao();
		}		
		return instancia;
	}
}	
