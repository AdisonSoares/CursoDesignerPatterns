 ...
 *
 * @Controlador
 * O primeiro objeto a receber uma requisição de uma inteface grafica com o usuário se 
 * chama controlador, ele define o fluxo de execução da aplicação.
 * 
 * 
 ...
 */
public abstract class Adapter_SistemaEstoqueGeral {
