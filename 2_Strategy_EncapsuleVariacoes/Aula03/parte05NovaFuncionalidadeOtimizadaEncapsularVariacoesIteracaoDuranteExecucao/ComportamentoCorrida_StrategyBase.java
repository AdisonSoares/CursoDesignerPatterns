 ...
 * se baseia no principio de designer que resolve o problema de 
 ...
 * alteradas ou extendidas sem que haja alguma alteração nas
 ...
 *
 * No exemplo depois de se encapsular as caracteristicas que variam e
 * criar um objeto para delegar funçoes é preciso modificar o construtor
 * para permitir a composiçao de um jogador com uma estrategia
 * especifica de corrida.
 * 
 * @Tirar o código que varia entre as subclasses e colocar em uma
 * hierarquia separada usa o principio de programar para 
 * interface e favorecer a composição sobre herança.
 */
public interface ComportamentoCorrida_StrategyBase {
	void correr();
}
