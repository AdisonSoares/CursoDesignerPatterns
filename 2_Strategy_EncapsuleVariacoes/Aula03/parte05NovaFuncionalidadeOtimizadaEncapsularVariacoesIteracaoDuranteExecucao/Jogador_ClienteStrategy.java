 ...
 * dos jogadores.
 * 
 * @IteraçãoAnterior1 da interface Corrida para encapsular o comportamento correr.
 * 
 ...
 * 
 * @IteraçãoAnterior2 o comportamento correr foi separado da classe jogador para compor
 ...
 * 
 * @IteraçãoAtual em tempo de execução criou-se o método setComportamentoCorrida para alterar
 * o comportamento de corrida, sem precisar implementar nas outras classes apenas na execução.
 */
public abstract class Jogador_ClienteStrategy {
	...
	private ComportamentoCorrida_StrategyBase comportamentoCorrida;
	...
	protected Jogador_ClienteStrategy(String nome, ComportamentoCorrida_StrategyBase comportamentoCorrida) {
		this.nome = nome;
	...
	public void setComportamentoCorrida(ComportamentoCorrida_StrategyBase comportamentoCorrida) {
		this.comportamentoCorrida = comportamentoCorrida;
	}
