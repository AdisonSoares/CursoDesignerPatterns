 ...
 * como diferencial o target(alvo), que não é uma interface é uma classe,
 * já que em java não permite herança multipla, precisa fazer com que
 * o adapter herde de target, em vez de implementar o target, fazendo
 * com que o adapter não herde do adaptee.
 * 
